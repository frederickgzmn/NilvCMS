      		...
      		<div class="widget stacked" style="margin-left: 128px;">
				...
				<div class="widget-content">
					...
					<div id="tabs">
						...
						<div id="tabs-gen">
							<form class="form-horizontal" method="post" id="form_config" name="form_config" action="{base_url}index.php/process/Nilv_set_settings/1" novalidate="novalidate">
								<fieldset>
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="text" id="titulo" name="titulo" value="{titulo}" class="input-large preg_conf" >
									  </div>
									</div>
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="text" id="slogan" name="slogan" value="{slogan}" class="input-large preg_conf">
									  </div>
									</div>
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="text" id="meta_p" name="meta_p" value="{meta_p}" class="input-large preg_conf">
									  </div>
									</div>
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="email" id="emailsis" name="emailsis" value="{emailsis}" class="input-large preg_conf">
									  </div>
									</div>
									<div class="control-group">
									  ...
									  <div class="controls">
										<input type="email" id="emailcon" name="emailcon" value="{emailcon}" class="input-large preg_conf">
									  </div>
									</div>
									<div class="control-group">
									...
									<div class="controls">
									  <select name="idiomat" id="idiomat" class="preg_conf">
										...
										<option {idiomat} value="en">English</option>
									  </select>
									</div>
								  </div>
									...
									<div class="tituloslog">
									 ...
									 <div class="controls">
									  <select name="estadoweb" id="estadoweb" class="preg_conf">
										...
										<option {estadoweb} value="N">En Mantenimiento</option>
									  </select>
									</div>
								  </div>
									<div class="control-group">
									  ...
									  <div class="controls">
										<textarea rows="4" id="msgmante" name="msgmante" class="span4 preg_conf">{msgmante}</textarea>
									  </div>
									</div>
