...
class Process extends CI_Controller {
	...
	public function modific_usuario($nombre,$apellido,$email,$usuario=""){
		...
		$resultado = $this->Usuarios_model->modificar_usuario($nombre,$apellido,$email,$usuario);
		if($resultado==true){
	...
	public function insert_usuario($nombre,$apellido,$email,$usuario,$passwd){
		$this->load->model('Usuarios_model');
		$resultado = $this->Usuarios_model->insertar_usuario($nombre,$apellido,$email,$usuario,$passwd);
		if($resultado==true){
	...
	public function login_usuario(){
		...
		if($passwd!="" and $usuario!=""){
			$this->load->model('Usuarios_model');
			$resultado = $this->Usuarios_model->login($usuario,$passwd);
	...
	public function priv_crea_modif($accion,$nombre,$estado="",$codigo=""){
		$this->load->model('Usuarios_model');
		$resultado = $this->Usuarios_model->modif_insert_priv($accion,$nombre,$estado,$codigo);
		if($resultado=="insed"){
	...
	public function cat_crea_modif($accion,$nombre,$estado="",$codigo=""){
		$this->load->model('Usuarios_model');
		$resultado = $this->Usuarios_model->modif_insert_cat($accion,$nombre,$estado,$codigo);
		if($resultado=="insed"){
	...
	public function rel_usuario_grupo($usuario,$grupo){
		if(isset($usuario) and isset($grupo)){
			...
			$resultado = $this->Usuarios_model->rel_usu_grup($usuario,$gruparray);
			if($resultado=="insed"){
	...
	public function rel_priv_grupo($grupo,$priv){
		if(isset($priv) and isset($grupo)){
			...
			$resultado = $this->Usuarios_model->rel_priv_grup($grupo,$gruparray);
			if($resultado=="insed"){
